...
const actors = [
  ...
  function introduceTheActors(actors){
      let arr = [];
      for(i=0; i<actors.length;i++ ){
          arr.push("Hi I'm " + actors[i].name + " and I was in " + actors[i].movie + ".")
      }
      return arr;
  }
  ...
  function goToSecondClass(second){
      return "Time to go to " + second + " class!"
  }
